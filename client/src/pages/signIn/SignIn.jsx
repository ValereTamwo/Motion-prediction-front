...
const logGoogleUser = async () => {
    ...
    // <section className="b bg-gray-900 h-screen  flex items-center  justify-center">
        <>{ open &&
            <>
                <div className=" h-[200px] absolute top-0 mt-[70px] mr-4 right-0 border   border-black   w-1/4 rounded-lg flex flex-col items-center ">
            ...
            <div className=" p-4">
                ...
                <button onClick={logGoogleUser} className="   ">Sign In With Google</button>
            </div>
        </div >
            </>
    }</>
