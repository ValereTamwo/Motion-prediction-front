...
import VideoFormModal from './AddVideoModal'
function Video() {
    ...
    <section className='header h-full'>
      {videos.length > 0 ?
        <>
              ...
              <h2 className='font-bold text-2xl '><span className='text-sm'>acceuil > </span> Mes Videos</h2>
      ...
      <div className='addvido h-[60px] bg-white flex items-center justify-between'>
         <div className="px-6 pt-4 pb-2">
                <button  onClick={() => setIsModalOpen(true)} className="bg-gray-800 hover:bg-gray-700 text-white  py-2 px-4 rounded">
                    Ajouter des Videos
              </button>
                  <VideoFormModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}  />
              </div>
              <div className='mr-4'> 
